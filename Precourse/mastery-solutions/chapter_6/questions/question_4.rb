...
directions = ['hall']
while directions[-2..-1] != ['study', 'code']
  player = gets.chomp
  if player == 'quit'
    puts 'Bye!'
    break
  elsif directions[-1] == 'hall' and player == 'look'
    puts "You are standing in a hall with a marble floor. You see a door."
  elsif directions[-1] == 'hall' and player == 'north'
    directions.push('study')
  elsif directions[-1] == 'study' and player == 'look'
    puts "You are in a warm and cosy study. You see a safe. You see a desk."
  elsif directions[-1] == 'study' and player == 'look at desk'
    puts "You see a piece of paper that reads, The combination is 2451."
  elsif directions[-1] == 'study' and player == 'south'
    directions.push('hall')
  elsif directions[-1] == 'study' and player == "enter combination 2451"
